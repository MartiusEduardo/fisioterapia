Public Class form_relatorio_ISACLI

    Private Sub form_relatorio_ISACLI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            '-----------------------------------------------------------------------------------------------------------------------------
            'CONEXÃO
            ...
            Dim data As String = My.Settings.ConsultaData
            ...
            Me.ISACLIReportViewer.RefreshReport()
